...
from karabo.middlelayer import (
    AccessMode, Bool, Configurable, Device, Double, Hash, Int32, MetricPrefix,
    Node, Overwrite, QuantityValue, Slot, State, String, Unit, VectorString,
    background, get_timestamp, isSet, slot, unit)

from ._version import version as deviceVersion
from .scenes.simulated_mc2_scene import get_scene
...
class SimulatedBeckhoffMC2Base(Device):
    ...
    availableScenes = VectorString(
        ...
        displayType="Scenes",
        description="Provides an autogenerated scene",
        accessMode=AccessMode.READONLY,
        defaultValue=['Scene'])
    ...
    def requestScene(self, params):
        name = params.get('name', default='default_scene')
        if name == 'default_scene':
            name = "Scene"

        payload = Hash('success', True, 'name', name,
                       'data', get_scene(self.deviceId), name)
