...
def get_scene(deviceId):
    ...
    scene05 = ColorBoolModel(height=21, invert=True, keys=[f'{deviceId}.isCWLimit'], parent_component='DisplayComponent', width=21, x=640, y=110)
    scene06 = ColorBoolModel(height=21, invert=True, keys=[f'{deviceId}.isSWLimitHigh'], parent_component='DisplayComponent', width=21, x=610, y=110)
    ...
    scene012 = ColorBoolModel(height=21, invert=True, keys=[f'{deviceId}.isSWLimitLow'], parent_component='DisplayComponent', width=21, x=83, y=110)
    scene013 = ColorBoolModel(height=21, invert=True, keys=[f'{deviceId}.isCCWLimit'], parent_component='DisplayComponent', width=21, x=43, y=111)
    ...
    scene016 = DisplayLabelModel(font_size=10, font_weight='normal', height=27, keys=[f'{deviceId}.targetPosition'], parent_component='DisplayComponent', width=101, x=200, y=160)
    ...
    scene018 = DisplayCommandModel(font_size=10, height=32, keys=[f'{deviceId}.move'], parent_component='DisplayComponent', width=101, x=490, y=155)
    scene019 = DisplayCommandModel(font_size=10, height=31, keys=[f'{deviceId}.stop'], parent_component='DisplayComponent', width=101, x=490, y=187)
    scene020 = DoubleLineEditModel(decimals=5, height=27, keys=[f'{deviceId}.targetPosition'], parent_component='EditableApplyLaterComponent', width=137, x=300, y=160)
    scene021 = DisplayLabelModel(font_size=14, font_weight='normal', height=31, keys=[f'{deviceId}.actualPosition'], parent_component='DisplayComponent', width=171, x=330, y=60)
